...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-!uiu3_r^2qxanli05*m^ky*zhe$gze80h-1+$$783wq40i_!g5')
...
# Use simpler storage to prevent startup crashes if manifest is missing
